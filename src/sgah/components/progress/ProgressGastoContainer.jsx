...
import { useGastoUi } from '../../../hooks';
import { DetailSaldoParagraph } from '../paragraphs';

export const ProgressGastoContainer = React.memo(
    ({ historicalBalanceByMonths, year }) => {
        const {
            styleFlipCardHover,
            handleShowFlipCard,
